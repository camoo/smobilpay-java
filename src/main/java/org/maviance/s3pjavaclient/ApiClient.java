...
public class ApiClient {
    ...
    private String accessToken; // User access token
    private String accessSecret; // User access secret.
     ...
     */
    public ApiClient(String baseUrl, String accessToken, String accessSecret) {
        basePath = baseUrl;
        ...
        setLocalDateFormat(DateTimeFormatter.ISO_OFFSET_DATE_TIME);

        // Setup authentications (key: authentication name, value: authentication).
        authentications = new HashMap<String, Authentication>();
        authentications.put("s3pAuth", new S3PAuth()); // Set S3PAuth as the authentication standard
        // used.
     ...
     * Set base path
     * @param basePath
     *            Base path of the URL (e.g https://localhost/v2
     ...
     */
    public ApiClient setVerifyingSsl(boolean verifyingSsl) throws GeneralSecurityException {
     ...
     * @throws GeneralSecurityException
     */
    public ApiClient setSslCaCert(InputStream sslCaCert) throws GeneralSecurityException {
     ...
     * @throws GeneralSecurityException
     */
    public ApiClient setKeyManagers(KeyManager[] managers) throws GeneralSecurityException {
    ...
    /**
     * Helper method to set s3pAuth authorization string for the first S3PAuth authentication
     * @param s3pAuthorizationString
     *            s3pAuth authorization string
     */
    public void setS3pAuthorizationString(String s3pAuthorizationString) {
        for (Authentication auth : authentications.values()) {
            if (auth instanceof S3PAuth) {
                ((S3PAuth) auth).setS3pAuthorizationString(s3pAuthorizationString);
                return;
            }
        }
        throw new S3PAuthException();
    }
    ...
    /**
     * Formats the specified query parameter to a list containing a single {@code Pair} object. Note
     * that {@code value} must not be a collection.
     * @param name
    ...
    /**
     * Formats the specified collection query parameters to a list of {@code Pair} objects. Note
     * that the values of each of the returned Pair objects are percent-encoded.
     ...
     *             Content-Type of the response is not supported.
     */
    ...
    public <T> T handleResponse(Response response, Type returnType) throws ApiException {
        if (response.isSuccessful()) {
            if (returnType == null || response.code() == 204) {
                ...
                if (response.body() != null) {
                    try {
                        ...
                        throw new ApiException(response.message(), e, response.code(), response.headers()
                                .toMultimap());
                    }
                }
                return null;
            ...
            throw new ApiException(response.message(), response.code(), response.headers()
                    .toMultimap(), respBody);
        }
    }
    ...
    public Call buildCall(String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams,
        ...
        List<Pair> data = HMACSignature.buildSignatureData(queryParams, collectionQueryParams, body);
        // setS3pAuthorizationString(buildAuthorizationHeader(path, method, data));
        //From here, signature has already been generated
        headerParams.put("Authorization", buildAuthorizationHeader(path, method, data));
    ...
    public Request buildRequest(String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams,
        ...
        if (progressRequestListener != null && reqBody != null) {
            ...
            request = reqBuilder.method(method, reqBody)
                    .build();
        }
    ...
    public RequestBody buildRequestBodyMultipart(Map<String, Object> formParams) {
        ...
        for (Entry<String, Object> param : formParams.entrySet()) {
            if (param.getValue() instanceof File) {
                ...
                mpBuilder.addFormDataPart(param.getKey(), param.getValue().toString());
            }
        }
